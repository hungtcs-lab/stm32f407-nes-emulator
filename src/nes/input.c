...
static const key_t keys[] = {
    ...
    { GPIOE, GPIO_PIN_2,  NES_BTN_SELECT, 0 },
    { GPIOC, GPIO_PIN_13, NES_BTN_START,  0 },
    /* 板载按键 */
    { GPIOE, GPIO_PIN_4,  NES_BTN_START,  0 },   /* KEY0 */
    { GPIOE, GPIO_PIN_3,  NES_BTN_SELECT, 0 },   /* KEY1 */
    { GPIOA, GPIO_PIN_0,  NES_BTN_A,      1 },   /* WK_UP */
};
